...
//
// WARNING!!! PSRAM IC requaired for UXGA resolution and high JPEG quality
...
void setup() {
  ...
  quickEspNow.begin(); // If you use no connected WiFi channel should be specified
}
